      ...
      <div className="max-w-5xl mx-auto px-6 py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 md:gap-12 items-start">
          <div className="space-y-8">
            <div className="card-minimal">
              ...
              <h1 className="text-3xl md:text-4xl font-light leading-tight tracking-tight">
                ...
                <br />
                <span className="mono-text text-[var(--fg-secondary)]">I build</span>{" "}
                <span className="font-normal">MVPs</span>
                <br />
                <span className="mono-text text-[var(--fg-secondary)]">and</span>{" "}
                <span className="font-normal">full-stack products</span>
              </h1>
            </div>

            <div className="solid-border p-6 bg-[var(--bg)]">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <button
                onClick={copyEmail}
                className="group flex items-center gap-2 mono-text text-xs tracking-wider text-[var(--fg-muted)] hover:text-[var(--accent)] transition-colors"
              >
                <Copy size={12} />
          ...
          <div className="hidden md:block">
            ...
            <p className="mono-text text-[10px] tracking-wider text-[var(--fg-dim)] mt-2 text-center">
              [{currentTime}]
            </p>
          </div>
        </div>
